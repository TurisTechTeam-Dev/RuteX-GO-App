...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Extraemos la misión (espera la clave 'mision' enviada desde el escáner)
    final Map<String, dynamic>? data = (args is Map<String, dynamic>) ? args['mision'] : null;

    // Pantalla de carga si los datos no han llegado
    if (data == null || data['preguntas'] == null) {
      return const Scaffold(
        body: Center(child: CircularProgressIndicator(color: Color(0xFF1B6A41))),
      );
    }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(data['titulo'] ?? "Misión", style: const TextStyle(color: Colors.black)),
        backgroundColor: Colors.white,
        elevation: 0,
        centerTitle: true,
        leading: IconButton(
      ...
      body: isSaving
          ? const Center(child: CircularProgressIndicator(color: Color(0xFF1B6A41)))
        ...
        child: Column(
          ...
          children: [
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: isSelected ? const Color(0xFF1B6A41) : Colors.grey[300]!,
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          radius: 15,
                          backgroundColor: isSelected ? const Color(0xFF1B6A41) : Colors.grey[200],
                          child: Text(
                            String.fromCharCode(64 + id), // Convierte 1 en A, 2 en B...
            ...
            CustomButton(
              text: _currentIndex < preguntas.length - 1 ? "SIGUIENTE" : "FINALIZAR",
